<%@ Page Title="" Language="C#" MasterPageFile="~/母版/MasterPage_Teacher.master" AutoEventWireup="true" CodeFile="T_PasswordChange.aspx.cs" Inherits="Teacher_T_PasswordChange" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="content_body">
        ...
        <br />
        <br />
        <p><asp:Button ID="Button1" runat="server" Height="34px" Text="保存" Width="78px" Font-Size="Large" Font-Bold="true" BorderColor="#CCFFCC" ForeColor="#FF99FF" OnClick="Button1_Click1" /></p>
